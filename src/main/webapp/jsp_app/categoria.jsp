<%-- 
    Document   : index.jsp
    Created on : 29-jun-2019, 10:10:36
    Author     : edinson
--%>
        ...
        <div class="page-container">
            ...
            <div class="sidebar-menu">
                <div class="sidebar-header">
                    ...
                    <br>
                    <h6 class="text-center" style="color: aliceblue"><i class="fa fa-user"></i> <strong>EDINSON SYSTEM</strong></h6>
                </div>
                <div class="main-menu">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class=" col-md-10 col-12">
                                            <nav>
                                                <ul id="paginationCategoria" class="pagination-sm justify-content-end">
